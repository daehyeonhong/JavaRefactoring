...
public class StudyPrinter {
    ...
    public void execute() throws IOException {
        try (FileWriter fileWriter = new FileWriter("participants.md");
            ...
            writer.print(header(this.totalNumberOfEvents, this.participants.size()));
    ...
    private String getMarkdownForParticipant(final Participant p) {
        return String.format("| %s %s | %.2f%% |\n", p.username(), checkMark(p, totalNumberOfEvents), p.getRate(this.totalNumberOfEvents));
    }
