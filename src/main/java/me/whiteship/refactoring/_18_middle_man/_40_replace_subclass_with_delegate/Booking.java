...
public class Booking {
    ...
    public static Booking createBooking(final Show show, final LocalDateTime time) {
        return new Booking(show, time);
    }

    public static Booking createPremiumBooking(final Show show, final LocalDateTime time, final PremiumExtra extra) {
        final Booking booking = new Booking(show, time);
